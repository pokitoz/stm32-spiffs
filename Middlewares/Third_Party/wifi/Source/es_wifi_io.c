...
int8_t SPI_WIFI_Init(uint16_t mode)
{
  ...
  if (mode == ES_WIFI_INIT)
  {
    ...
    hspi.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_8; //SPI_BAUDRATEPRESCALER_8;
        /* 80/8= 10MHz (Inventek WIFI module supports up to 20MHz)*/
